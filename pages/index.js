					...
					<div className="flex flex-1 flex-col items-start justify-between">
						<div className="mb-10 sm:mb-0">
							<div className="flex flex-row">
								<h1 className="text-5xl text-moon">
									Tip Party
								</h1>
								<div className="ml-3">
									<Icon />
						...
						<div className="sm:hidden flex flex-1 sm:mb-0 shadow-md border border-violet-dark mb-8">
							<iframe
								width="853"
								height="480"
								src={`https://www.youtube.com/embed/bZonreoLVRI`}
								frameBorder="0"
				...
				<section className="flex w-full flex-col py-20 sm:pb-20 pb-8 border-t border-violet-dark">
					...
					<div className="flex flex-col w-full text-xl poppins my-8">
						<h3 className="text-violet">
							I want to earn tokens. How do I receive tokens
							through Tip Party?
						</h3>
						<p className="mt-5 text-elder">
							First, you want to join a Tip Room. You can do this
							either by entering the "secret" word in the home
							page, or you can directly follow a link to the Tip
							Room. Once in the room, you simply click "Sign In",
							and sign the message with your Ethereum wallet.
						</p>
					</div>
					{/* Question: 2 */}
					<div className="flex flex-col w-full text-xl poppins my-8">
						<h3 className="text-violet">
							I want to distribute tokens. How do I host my own
							Tip Party?
						</h3>
						<p className="mt-5 text-elder">
							First, click the "Become a distributor" button in
							order to have distributor rights. Once assigned as
							an "admin", enter a "secret" word of your choice in
							order to load up a unique room. Then invite other
							members by sharing this word with the members you
							want to tip. Once your members have all successfully
							signed in, you can distribute funds in any token of
							your choice.
						</p>
					</div>
					...
					<div className="flex flex-col w-full text-xl poppins my-8">
						...
						<p className="mt-5 text-elder">
							The Moonshot Collective built it because we wanted
							to use it ourselves. We have many community members
							from across the Ethereum ecosystem, and wanted a
							universal way to reward engagement in the
							Collective.
						</p>
					</div>
					...
					<div className="flex flex-col w-full text-xl poppins my-8">
						<h3 className="text-violet">
							I want to use Tip.Party for my own community. Is
							that cool?
						</h3>
						<p className="mt-5 text-elder">
							Yes aboslutely, please go ahead. After you do, let
					...
					<div className="flex flex-col w-full text-xl poppins my-8">
						<h3 className="text-violet">
							Where does the 0.01 ETH to ‘become a distributor’
							go? Why would I want to pay that?
						</h3>
						<p className="mt-5 text-elder">
							You can host your own Tip.Party once you pay the
							0.01 ETH fee! All funding goes to funding public
							goods on Gitcoin Grants.
						</p>
					</div>
